...
{
    public partial class 客戶基本建檔_列印 : FormT
    {
        ...
        void loadDB()
        {
            try
            {
                ...
                {
                    cn.Open();
                    string str = "select * from cust where cuno >=N'" + CuNo.Text + "' COLLATE Chinese_Taiwan_Stroke_BIN";
                    if (CuNo_1.Text.Trim() != "")
                        str += " and cuno <= N'" + CuNo_1.Text + "' COLLATE Chinese_Taiwan_Stroke_BIN";
