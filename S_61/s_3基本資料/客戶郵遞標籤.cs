...
{
    public partial class 客戶郵遞標籤 : FormT
    {
        ...
        private void btnBrow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string str = "select 列印='Y',* from cust where  CuNo >=N'" + CuNo.Text + "'";
                    if (CuNo_1.Text.Trim() != "")
                        str += " and CuNo <= '" + CuNo_1.Text + "'";
                    if (CuX1No.Text.Trim() != "")
                        str += " and CuX1No >= '" + CuX1No.Text + "'";
                    if (CuX1No_1.Text.Trim() != "")
                        str += " and CuX1No <= '" + CuX1No_1.Text + "'";
                    if (CuEmNo1.Text.Trim() != "")
                        str += " and CuEmNo1 >= '" + CuEmNo1.Text + "'";
                    if (CuEmNo1_1.Text.Trim() != "")
                        str += " and CuEmNo1 <= '" + CuEmNo1_1.Text + "'";
                    if (CuR1.Text.Trim() != "")
                        str += " and CuR1 >= '" + CuR1.Text + "'";
                    if (CuR1_1.Text.Trim() != "")
                        str += " and CuR1 <= '" + CuR1_1.Text + "'";
                    if (CuX4No.Text.Trim() != "")
                        str += " and CuX4No >= '" + CuX4No.Text + "'";
                    if (CuX4No_1.Text.Trim() != "")
                        str += " and CuX4No <= '" + CuX4No_1.Text + "'";
                    if (CuName1.Text.Trim() != "")
                        str += " and CuName1 like('" + CuName1.Text.Trim() + "%')";
                    if (CuIme.Text.Trim() != "")
                        str += " and CuIme like('" + CuIme.Text.Trim() + "%')";
                    if (CuTel1.Text.Trim() != "")
                        str += " and CuTel1 like('" + CuTel1.Text.Trim() + "%')";
                    if (CuAddr1.Text.Trim() != "")
                        str += " and CuAddr1 like('%" + CuAddr1.Text.Trim() + "%')";
                    if (CuMemo1.Text.Trim() != "")
                        str += " and CuMemo1 like('%" + CuMemo1.Text.Trim() + "%')";
                    if (CuUdf1.Text.Trim() != "")
                        str += " and CuUdf1 like('%" + CuUdf1.Text.Trim() + "%')";
        ...
        private void FrmPrint_C_KeyDown(object sender, KeyEventArgs e)
        {
