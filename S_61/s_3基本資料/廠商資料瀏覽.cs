...
{
    public partial class 廠商資料瀏覽 : FormT
    {
        ...
        private void FrmFactInfo_Load(object sender, EventArgs e)
        {
        ...
        private void btnBrow_Click(object sender, EventArgs e)
        {
            ...
            {
                if (FaNo.Text.CompareTo(FaNo_1.Text) > 0)
                {
            ...
            if (FaX12no.Text.Trim() != "" && FaX12no_1.Text.Trim() != "")
            {
                ...
                if (FaX12no.Text.CompareTo(FaX12no_1.Text) > 0)
                {
            ...
            {
                if (FaEmno1.Text.CompareTo(FaEmno1_1.Text) > 0)
                {
            ...
            if (FaX4no.Text.Trim() != "" && FaX4no_1.Text.Trim() != "")
            {
                ...
                if (FaX4no.Text.CompareTo(FaX4no_1.Text) > 0)
                {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(Common.浮動連線字串))
                {
                    ...
                    if (FaX12no.Text.Trim() != "")
                        str += " and FaX12no >= N'" + FaX12no.Text + "'";
                    if (FaX12no_1.Text.Trim() != "")
                        str += " and FaX12no <= N'" + FaX12no_1.Text + "'";
                    if (FaEmno1.Text.Trim() != "")
                        str += " and FaEmno1 >= N'" + FaEmno1.Text + "'";
                    if (FaEmno1_1.Text.Trim() != "")
                        str += " and FaEmno1 <= N'" + FaEmno1_1.Text + "'";
                    if (FaR1.Text.Trim() != "")
                        str += " and FaR1 >= N'" + FaR1.Text + "'";
                    if (FaR1_1.Text.Trim() != "")
                        str += " and FaR1 <= N'" + FaR1_1.Text + "'";
                    if (FaX4no.Text.Trim() != "")
                        str += " and FaX4no >= N'" + FaX4no.Text + "'";
                    if (FaX4no_1.Text.Trim() != "")
                        str += " and FaX4no <= N'" + FaX4no_1.Text + "'";
        ...
        private void FrmFactInfo_KeyDown(object sender, KeyEventArgs e)
        {
