...
{
    public partial class 廠商類別建檔_瀏覽 : FormT
    {
        ...
        private void 廠商類別建檔_瀏覽_Load(object sender, EventArgs e)
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection cn = new SqlConnection(Common.浮動連線字串))
            {
                ...
                try
                {
                    ...
                    {
                        cmd.CommandText += "update xx12 set x12name='" + i.Cells["類別名稱"].Value.ToString().Trim() + "'"
                            + " where x12no='" + i.Cells["類別編號"].Value.ToString().Trim() + "';";
                    }
                    cmd.ExecuteNonQuery();
                    tran.Commit();
                    loadM();
        ...
        private void 廠商類別建檔_瀏覽_KeyUp(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F11:
        ...
        private void X12No_KeyUp(object sender, KeyEventArgs e)
        {
            if (dataGridViewT1.Rows.Count == 0 || X12No.Text.Trim() == "") return;
            dataGridViewT1.Search("類別編號", X12No.Text.Trim());
        }
