...
{
    public partial class 帳款匯出作業_瀏覽 : FormT
    {
        ...
        public 帳款匯出作業_瀏覽()
        {
            ...
            this.匯出金額.DefaultCellStyle.Format = "N" + Common.金額小數;
            count.Text = "";
        ...
        private void 帳款匯出作業_瀏覽_Load(object sender, EventArgs e)
        {
        ...
        private void loadM(string str)
        {
            try
            {
                ...
                {
                    cn.Open();
                    string sql = "select 日期='',序號='',* from remito order by " + str;
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            {
                loadM("ReNo");
                dataGridViewT1.Search("匯出證號", qReNo.Text);
                SetButtonColor();
                query3.ForeColor = Color.Red;
                btnQuery.Enabled = true;
                btnQuery.Focus();
            ...
            {
                loadM("FaNo");
                dataGridViewT1.Search("fano", qFaNo.Text);
                SetButtonColor();
                query5.ForeColor = Color.Red;
                btnQuery.Enabled = true;
                btnQuery.Focus();
        ...
        private void btnGet_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridViewT1.SelectedRows.Count > 0)
                Result = dataGridViewT1.SelectedRows[0].Cells["匯出證號"].Value.ToString().Trim();
            this.Close();
            this.Dispose();
        }
        ...
        private void 帳款匯出作業_瀏覽_KeyUp(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F3:
