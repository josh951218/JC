...
{
    public partial class 應付票據建檔_瀏覽 : FormT
    {
        ...
        private void 應付票據建檔_瀏覽_Load(object sender, EventArgs e)
        {
        ...
        private void loadM(string str)
        {
            try
            {
                ...
                {
                    cn.Open();
                    string sql = "select 異動日期='',預兌日='',到期日='',開票日='',序號='',* from chko order by " + str;
                    ...
                    if (table.Rows.Count > 0)
                    {
                        for (int i = 0; i < table.Rows.Count; i++)
                        {
                            ...
                            table.Rows[i]["開票日"] = Common.User_DateTime == 1 ? Date.AddLine(table.Rows[i]["ChDate1"].ToString()) : Date.AddLine(table.Rows[i]["ChDate1_1"].ToString());
                        }
        ...
        {
            NO = dataGridViewT1.SelectedRows[0].Cells["序號"].Value.ToString();
            table.DefaultView.Sort = "ChStatus,chdate2 desc";
            SetButtonColor();
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            {
                loadM("CoNo,ChNo");
                //table.DefaultView.Sort = "CoNo,ChNo";
            ...
            if (qChStatus.Text.Trim() != "")
            {
                ...
                //table.DefaultView.Sort = "ChStatus,ChNo";
            ...
            if (qFaNo.Text.Trim() != "")
            {
                ...
                //table.DefaultView.Sort = "FaNo,ChNo desc";
            ...
            if (qChDate.Text.Trim() != "")
            {
                ...
                //table.DefaultView.Sort = "ChDate,ChNo";
            ...
            if (qChDate3.Text.Trim() != "")
            {
                ...
                //table.DefaultView.Sort = "ChDate3,ChNo";
                if(Common.User_DateTime == 1)
            ...
            if (qChDate2.Text.Trim() != "")
            {
                ...
                //table.DefaultView.Sort = "ChDate2,ChNo";
                if(Common.User_DateTime == 1)
            ...
            if (qChDate1.Text.Trim() != "")
            {
                ...
                //table.DefaultView.Sort = "ChDate1,ChNo";
                if(Common.User_DateTime == 1)
        ...
        private void 應付票據建檔_瀏覽_KeyUp(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F2:
