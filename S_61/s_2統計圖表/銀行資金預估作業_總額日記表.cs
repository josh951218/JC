...
{
    public partial class 銀行資金預估作業_總額日記表 : FormT
    {
        public List<String> acno_list;
        public DataTable table;
        public 銀行資金預估作業_總額日記表()
        {
            InitializeComponent();
        ...
        private void 銀行資金預估作業_總額日記表_Load(object sender, EventArgs e)
        {
        ...
        RPT paramsInit()
        {
            string path = Common.reportaddress + "Report\\銀行資金預估作業_總額日記表.rpt";
