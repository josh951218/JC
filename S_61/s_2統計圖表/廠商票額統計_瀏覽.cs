...
{
    public partial class 廠商票額統計_瀏覽 : FormT
    {
        ...
        {
            InitializeComponent();
            Num = new List<txtNumber>() { Tot, Tot_1, Tot_2, Tot_3, Tot_4, Tot_5, Tot_6};
            Num.ForEach(r =>
            {
                r.NumThousands = true;
        ...
        private void 廠商票額統計_瀏覽_Load(object sender, EventArgs e)
        {
            ...
            this.票已領取.DefaultCellStyle.Format = "N" + Common.金額小數;
            this.兌現.DefaultCellStyle.Format = "N" + Common.金額小數;
            this.作廢.DefaultCellStyle.Format = "N" + Common.金額小數;
            ...
            decimal tot = 0, tot_1 = 0, tot_2 = 0, tot_3 = 0, tot_4 = 0, tot_5 = 0, tot_6 = 0;
            table.AsEnumerable().ToList().ForEach(r =>
            {
                tot += r["小計"].ToDecimal();
                tot_1 += r["未處理"].ToDecimal();
                tot_2 += r["票已領取"].ToDecimal();
                tot_3 += r["兌現"].ToDecimal();
                tot_4 += r["退票"].ToDecimal();
                tot_5 += r["作廢"].ToDecimal();
                tot_6 += r["其他"].ToDecimal();
            });
        ...
        RPT paramsInit()
        {
            string path = Common.reportaddress + "Report\\廠商票額統計_標準報表.rpt";
