...
{
    public partial class 應付票據明細 : FormT
    {
        ...
        private void 應付票據明細_Load(object sender, EventArgs e)
        {
        ...
        private void btnBrow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    cn.Open();
                    string sql = "select 序號='',* from chko where '0'='0'"
                ...
                using (應付票據明細_瀏覽 frm = new 應付票據明細_瀏覽())
                {
                    frm.SetParaeter();
                    frm.table = table;
        ...
        private void ChDate_1_Validating(object sender, CancelEventArgs e)
        {
            if (btnExit.Focused) return;
